...
public class NmComponentes {
    ...
    public static final String EJEMPLO_CONV = "Ejemplo Conversión";
    public static final String AUTOGLC = "Ejemplo Automata a Gramatica";
    public static final String GLCTOAU = "Ejemplo Gramatica a Automata";
    ...
    public static final String MT = "Máquina de Turing Estandar";
    public static final String MTBD = "Máquina de Turing Bidireccional";
    ...
    public static final String EVALUAR = "ADP a GLC";
    ...
    public static String INFO_EVALUAR = "Evaluar: "
            + "\n\nSelecciona para realizar la conversion de un ADP a GLC."
            + "\n\nPara realizar la conversion del diagrama de un ADP se lanzara una ventana que muestra la conversion en GLC.";
