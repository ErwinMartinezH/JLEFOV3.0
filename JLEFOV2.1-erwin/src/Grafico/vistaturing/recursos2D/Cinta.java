...
public class Cinta extends ArrayList<Letra> implements Dibujar {
  ...
  public Cinta(TuringMachineSimulation vTS, String alfabeto, int x, int y, int anchoCuadro, int largoCuadrado) {
  ...
  private class Hilo extends Thread {
    ...
    public Hilo(Letra letra, TuringMachineSimulation vTS) {
      this.letra = letra;
      this.vTS = vTS;
    }
