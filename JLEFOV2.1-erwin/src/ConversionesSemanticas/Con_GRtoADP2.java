...
import static FuncionesSemanticas.DELIM_ALF.isNT;
...
public class Con_GRtoADP2 {
    ...
    java.util.ArrayList <EstructurasSemanticas.Regla2> producciones;
    ...
    java.util.ArrayList <EstructurasSemanticas.Estado> estados = new ArrayList<>();
    ...
    */
    public Con_GRtoADP2(java.util.ArrayList <EstructurasSemanticas.Regla2> producciones) {
