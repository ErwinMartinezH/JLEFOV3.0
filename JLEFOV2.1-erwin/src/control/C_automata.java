...
public class C_automata extends MouseAdapter implements ActionListener {
    ...
    private List<M_estado> estados= new ArrayList<>();
    private List<M_transicion> transiciones = new ArrayList<>();
    ArrayList<Estado> esta = new ArrayList<>();
    public Automata a = new Automata();
    ...
    public C_automata(V_lienzo dibujar, Rastreador rastreador) {
    }
