...
public class V_lienzo extends JPanel {//En este panel se dibuja el automata, Er o GLC
     ...
     * Constructor
     *
     * @param tipoPanel tipo de panel ER o AF o GLC o ADP
     */
    public V_lienzo(String tipoPanel) {
        ...
        if (tipoPanel.equals(AF)) {
            ...
            revalidate();
        } else if (tipoPanel.equals(MT)) {
            
            //COMPARTIENDO LOGICA DE LA BIDIRECCIONAL SOLO UNA BANDERA PARA ACT
            add(new TuringBidireccional(true));
            setBackground(new Color(53, 60, 81));
            revalidate();
        } else if (tipoPanel.equals(MTBD)) {
            add(new TuringBidireccional(false));
            setBackground(new Color(53, 60, 81));
            revalidate();
            ...
            JOptionPane.showMessageDialog(null, "No existe la opcion que quieres agregar");
        }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (tipoPanel.equals(AF) || tipoPanel.equals(ADP)) {
