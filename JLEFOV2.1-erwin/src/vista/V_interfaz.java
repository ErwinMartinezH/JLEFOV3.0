...
public class V_interfaz extends JFrame {
    ...
    private void componentes() {
        ...
        af.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A, InputEvent.SHIFT_DOWN_MASK | InputEvent.CTRL_DOWN_MASK));
        ...
        adp.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P, InputEvent.SHIFT_DOWN_MASK | InputEvent.CTRL_DOWN_MASK));
        adp.setIcon(new ImageIcon(getClass().getResource(rutaIconos + "adp-16.png")));
        adp.setName(ADP);
        adp.addActionListener(ctrl);
        adp.addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent e) {
                super.mousePressed(e);
                controlVisual(true, false, false, false);
        ...
        er.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_E, InputEvent.SHIFT_DOWN_MASK | InputEvent.CTRL_DOWN_MASK));
        er.setText(ER);
        er.setName(ER);
        ...
        glc.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_G, InputEvent.SHIFT_DOWN_MASK | InputEvent.CTRL_DOWN_MASK));
        glc.setText(GLC);
        glc.setName(GLC);
        ...
        mt.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_M, InputEvent.SHIFT_DOWN_MASK | InputEvent.CTRL_DOWN_MASK));
        mt.setIcon(new ImageIcon(getClass()
                .getResource(rutaIconos + "mt-16.png")));
        mt.setName(MT);
        mt.addActionListener(ctrl);
        nuevo.add(mt);

        mtbd.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_B, InputEvent.SHIFT_DOWN_MASK | InputEvent.CTRL_DOWN_MASK));
        mtbd.setIcon(new ImageIcon(getClass()
                .getResource(rutaIconos + "mt-16.png")));
        mtbd.setName(MTBD);
        mtbd.addActionListener(ctrl);
        nuevo.add(mtbd);
        ...
        auToglc.setName(AUTOGLC);
        auToglc.addActionListener(ctrl);
        ejemplo_Conv.add(auToglc);

        glcToau.setName(GLCTOAU);
        glcToau.addActionListener(ctrl);
        ejemplo_Conv.add(glcToau);
...
//        barraMenu.add(ejemplo_Conv);
    ...
    private final JMenu ejemplo_Conv = new JMenu(EJEMPLO_CONV);
    private final JMenuItem auToglc = new JMenuItem(AUTOGLC);
    private final JMenuItem glcToau = new JMenuItem(GLCTOAU);
    private final JMenuItem af = new JMenuItem(AF);
    private final JMenuItem adp = new JMenuItem(ADP);
    private final JMenuItem er = new JMenuItem(ER);
    private final JMenuItem mt = new JMenuItem(MT);
    private final JMenuItem mtbd = new JMenuItem(MTBD);
...
//            if (screenSize.getWidth() < 1920) {//para pantallas pequeñas
...
//    private V_tabs tabs;
    private final JPanel contenedor = new JPanel() {
        ...
        protected void paintComponent(Graphics g) {
            ...
            // Usar el tamaño del panel en lugar del tamaño de la pantalla
            Dimension panelSize = getSize();

            if (panelSize.getWidth() < 1920) { // Puedes ajustar este valor según tus necesidades
                img_pane = new ImageIcon(getClass().getResource(rutaIconos + "panel_Inicio2.png"));
            } else {
                img_pane = new ImageIcon(getClass().getResource(rutaIconos + "panel_Inicio1.png"));
            }
            ...
            g2.drawImage(img_pane.getImage(), 0, 0, (int) panelSize.getWidth(), (int) panelSize.getHeight(), this);
        }
    };
