...
public class CuadroDialogo extends JDialog {
  ...
  private TuringBidireccional mt;

  public CuadroDialogo(JFrame parent, JComboBox<String> comboBox_1, JComboBox<String> comboBox_2, JComboBox<String> comboBox_3, TuringBidireccional m_t, int x, int y) {
